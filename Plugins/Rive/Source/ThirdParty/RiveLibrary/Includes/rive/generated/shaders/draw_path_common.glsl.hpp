...
#if defined(_EXPORTED_ENABLE_FEATHER) || defined(_EXPORTED_ATLAS_COVERAGE)
TEXTURE_R16F_1D_ARRAY(PER_FLUSH_BINDINGS_SET,
                      FEATHER_TEXTURE_IDX,
                      _EXPORTED_featherTexture);
#endif
#ifdef _EXPORTED_ATLAS_COVERAGE
...
#if (defined(_EXPORTED_ENABLE_FEATHER) || defined(_EXPORTED_ATLAS_COVERAGE)) && !defined(_EXPORTED_VERTEX)
SAMPLER_LINEAR(FEATHER_TEXTURE_IDX, featherSampler)
#endif
#ifdef _EXPORTED_ATLAS_COVERAGE
...
#if defined(_EXPORTED_FRAGMENT) && defined(_EXPORTED_ATLAS_COVERAGE)
...
#if defined(_EXPORTED_VERTEX) && defined(_EXPORTED_ATLAS_COVERAGE)
INLINE float2
